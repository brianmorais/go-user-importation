...
func GetUsers() userModel.Users {
	return userModel.Users{
		userModel.User{
			...
			UserTypeId:           sql.NullInt32{Int32: userType.ActiveDirectory},
			...
			AccessTypeId:         sql.NullInt32{Int32: userAccessType.Employee},
		...
		userModel.User{
			...
			UserTypeId:           sql.NullInt32{Int32: userType.Database},
			...
			ModifiedDate:         sql.NullTime{Time: time.Date(2021, 10, 1, 12, 0, 0, 0, time.UTC)},
			ModifiedUser:         sql.NullString{String: "Admin"},
			AccessTypeId:         sql.NullInt32{Int32: userAccessType.Excecao},
			Locked:               sql.NullBool{Bool: false},
			ExpirationDate:       sql.NullTime{Time: time.Date(2023, 10, 1, 12, 0, 0, 0, time.UTC)},
		},
		userModel.User{
